# Dashboard-US-Candy-Sales-Performance
Dasboard for analyze the 2024 sugar sales target achievement rate and provide insights to reach 80% of the 2025 sales target, aiding company growth.


This project analyzes the 2024 sugar sales target achievement rate using the US Candy Distributor dataset to generate data-driven insights that can help the company reach 80% of the 2025 sales target and support overall business growth.
The analysis begins by identifying the business problem, where the sugar product category only achieved 0.78% of its sales target in 2024, indicating a significant gap between expected and actual performance. To clearly define the objective, the SMART framework (Specific, Measurable, Achievable, Relevant, and Time-bound) was applied.
1. Specific: Analyze sugar product sales performance using historical sales data.
2. Measurable: Evaluate the sales target achievement rate and track progress toward the 80% target in 2025.
